...
Expected SHA-256 for `localsync-1.5.2.jar`:

```text
AAF44A7515E68265BEB7A0F3328A14C23F25B5FDB541C249744D8F8A09E54CA8
```

Verify the downloaded JAR on Windows:

```powershell
Get-FileHash .\localsync-1.5.2.jar -Algorithm SHA256
```
